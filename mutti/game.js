...
var event1_0_3 = function event1_0_3() {
    state.delay += 5;
    state.disguise = 1;
    e.show("Du gehst zur Bushaltestelle. Angesichts deines Vorhabens, der Polizei und ihren magischen Spezialisten zuvor zu kommen, erscheint dir das Warten auf den Bus wie ein schlechter Scherz.<br/>Als der Bus endlich kommt, hat er zwei Minuten Verspätung und obwohl du weisst, dass zwei Minuten nur in schlechten Filmen entscheidend sind, hast du ein mulmiges Gefühl.<br/><br/>Als du zwanzig Minuten später aussteigst, begibst du dich möglichst schnell Richtung Praxis.", [new Choice("Weiter", "event1_1")]);
};

var event1_1 = function event1_1() {
    e.show("Die Praxis befindet sich in einem mehrstöckigen Reihenhaus an einer wenig befahrenen Straße. Vor dem Eingang stehen zwei Polizisten und halten jeden vom Betreten ab, der kein Mieter ist. Die Menge der neugierigen Zuschauer ist bereits auf ein paar Dutzend gestiegen und breitet sich bis auf die Straße aus. Ein Journalist spricht gerade in eine Kamera, während ein weiteres Übertragungsteam gerade seinen Wagen entlädt. Auf das Dach zu Schweben fällt also aus.", [new Choice("Weiter", "event1_1_0")]);
};

var event1_1_0 = function event1_1_0() {
    e.show("Du musst du dir irgendwie Zutritt zum Gebäude verschaffen. Zwar könntest du dich auf magische Art Tarnen, doch wenn sich einfach die Tür öffnet, wirkt dies mit Sicherheit verdächtig. Vielleicht kann man mit den Beamten am Eingang reden? Eine Seitengasse scheint hinter das Gebäude zu führen, vielleicht hast du Glück und findest eine Feuerleiter. Natürlich könntest du das Gebäude auch auf einer magischen Ebene betrachten, um Spuren magischer Energie zu finden, aber dies dauert eine Weile.", [new Choice("Ich rede mit den Polizisten.", "event1_1_1"), new Choice("Zuerst höre ich mich unter den Passanten um.", "event1_1_2"), new Choice("Die Rückseite des Gebäudes klingt vielversprechend.", "event1_1_3"), new Choice("Ich verschiebe meine Wahrnehmung auf das magische Spektrum.", "event1_1_4")]);
};

var event1_1_1 = function event1_1_1() {
    e.show("Die beiden Beamten wirken wie Türsteher. Gelangweilt und unnachgiebig.", [new Choice("„Einen schönen guten Abend. Was ist denn hier passiert?”", "event1_1_1_1"), new Choice("„Entschuldigen Sie, aber ich wohne hier.”", "event1_1_1_2"), new Choice("„Guten Abend Kollegen.” Es wird schließlich ein magischer Experte erwartet.", "event1_1_1_3"), new Choice("Ich überlege mir doch lieber etwas anderes.", "event1_1_0")]);
};

var event1_1_1_1 = function event1_1_1_1() {
    state.delay += 5;
    e.show("Bemüht höflich erwidert der größere von beiden: „Wir dürfen uns dazu leider nicht äußern. Entnehmen Sie weiteres bitte den Medien.” Der andere verdreht nur die Augen.", [new Choice("„Entschuldigen Sie, aber ich wohne hier.”", "event1_1_1_2"), new Choice("„Nur ein Scherz. Guten Abend Kollegen.” Es wird schließlich ein magischer Experte erwartet.", "event1_1_1_3"), new Choice("„Ich überlege mir doch lieber etwas anderes.", "event1_1_0")]);
};

var event1_1_1_2 = function event1_1_1_2() {
    state.delay += 5;
    e.show("Die beiden Beamten ringen sich ein Lächeln ab: „Können Sie sich ausweisen?” Verdammt.", [new Choice("„Hätte ich gewusst, dass ich sonst nicht in meine Wohnung komme, hätte ich meine Brieftasche samt Ausweis sicherlich mitgenommen. Bitte, es ist kalt!”", "event1_1_1_2_1"), new Choice("„Um in meine Wohnung zu kommen? Wollen Sie mich auf den Arm nehmen???”", "event1_1_1_2_2"), new Choice("„Bitte, ich muss echt dringend pinkeln.”", "event1_1_1_2_2")]);
};

var event1_1_1_2_1 = function event1_1_1_2_1() {
    if (state.mundane.value >= 30) {
        e.show("Der Beamte zögert, als sein Kollege ihm etwas ins Ohr flüstert. Dann zuckt er mit den Schultern: „Halten Sie sich bitte von der Praxis fern.”", [new Choice("„Hätte ich gewusst, dass ich sonst nicht in meine Wohnung komme, hätte ich meine Brieftasche samt Ausweis sicherlich mitgenommen. Bitte, es ist kalt!”", "event1_2")]);
    } else {
        e.show("„Tut mir sehr leid, aber so können wir sie nicht einfach durchlassen.”", [new Choice("Mist!", "event1_1_1")]);
    }
};

var event1_1_1_2_2 = function event1_1_1_2_2() {
    e.show("„Tut mir sehr leid, aber so können wir sie nicht einfach durchlassen.”", [new Choice("Mist!", "event1_1_1")]);
};

var event1_1_1_3 = function event1_1_1_3() {
    state.delay += 5;
    e.show("Die beiden sehen dich überrascht an... misstrauisch. Ängstlich? Sie mustern dich, offensichtlich nicht überzeugt.", [new Choice("„Schon gut, ich habe mir lediglich einen Scherz erlaubt.”", "event1_1_1_3_1"), new Choice("Ich demonstriere ihnen einen einfachen Zauber, um sie zu überrumpeln.", "event1_1_1_3_2")]);
};

var event1_1_1_3_1 = function event1_1_1_3_1() {
    e.show("Die beiden mustern dich finster: „Sie sind Reporter, oder? Möchten unbedingt rein, hm? Klar, die Polizei steht nur im Weg.”", [new Choice("Mist!", "event1_1_1")]);
};

var event1_1_1_3_2 = function event1_1_1_3_2() {
    state.delay += 5;
    state.profile += 30;
    e.show("Langsam – du möchtest keinen Zwischenfall provozieren – hebst du die linke Hand und murmelst eine Beschwörung. Einige Sekunden später erhebt sich eine kleine Lichtkugel über deinem Handteller. Überaus simpel, aber die Beamten zucken erschrocken zusammen. Du lächelst sie beruhigend an. Der kleinere von beiden schluckt und öffnet dir die Tür.", [new Choice("Weiter", "event1_2")]);
};

var event1_1_2 = function event1_1_2() {
...
var event1_2 = function event1_2() {
    ...
    if (state.event1_2_read) text = "Zurück im Treppenhaus stehst du erneut vor der Wahl eines Stockwerkes. Wo möchtest du suchen?";
    state.event1_2_read = 1;
    e.show(text, [new Choice("Im Erdgeschoß.", "event1_2_1"), new Choice("Im ersten Stock.", "event1_2_2"), new Choice("Im zweiten Stock.", "event1_2_3"), new Choice("Im dritten Stock.", "event1_2_4")]);
};

var event1_2_1 = function event1_2_1() {
    state.delay += 10;
    e.show("Das Erdgeschoß scheint schon bessere Zeiten gesehen zu haben. Das pastelblau hat sich zu einem pastelgrau gefärbt. Zusätzlich steht ein großer Kaktus auf dem Flur. Allerdings findest du keine Hinweise auf Praxis oder Polizei.", [new Choice("Weiter", "event1_2")]);
};

var event1_2_2 = function event1_2_2() {
    state.delay += 10;
    e.show("Niemand begegnet dir im ersten Stock. Die laute Musik, die hinter einer der Türen hervordringt, gibt dir zumindest das Gefühl, nicht allein zu sein. Trotzdem bist du hier falsch.", [new Choice("Weiter", "event1_2")]);
};

var event1_2_3 = function event1_2_3() {
    state.delay += 10;
    e.show("Im zweiten Stock riecht es leicht chemisch und das pastelblau der Wände scheint etwas kräftiger zu sein. Als du um eine Ecke biegst, siehst du, dass eine der Türen offen ist und ein Polizist davor steht. Bingo.", [new Choice("Weiter", "event1_3")]);
};

var event1_2_4 = function event1_2_4() {
    state.delay += 10;
    e.show("Im dritten Stock klebt der Boden und ein strenger Zitronengeruch hängt in der Luft. Ziemlich banal und definitiv der falsche Stock.", [new Choice("Weiter", "event1_2")]);
};

var event1_3 = function event1_3() {
    e.show("Der Polizist schaut auf sein Handy und scheint ein Gähnen zu unterdrücken. Ansonsten ist es ruhig. Der Rest des Flurs wirkt verlassen. Vermutlich sind die anderen Beamten in der Praxis.", [new Choice("Ich lausche. Vielleicht spricht er gleich noch mit einigen Kollegen.", "event1_3_1"), new Choice("Ich spreche einen Tarnzauber und schleiche mich in die Praxis.", "event1_3_2"), new Choice("Ich spreche vorher einen Schlafzauber auf den Beamten.", "event1_3_3"), new Choice("Ich wirke vorher einen Schockzauber, der ihm das Bewusstsein raubt.", "event1_3_4")]);
};

var event1_3_1 = function event1_3_1() {
    state.delay += 10;
    e.show("Angestrengt spitzt du die Ohren. Du hörst ein Grunzen von dem Beamten. Was auch immer er liest, es scheint ihm nicht zu Gefallen.", [new Choice("Ich warte weiter.", "event1_3_1_1"), new Choice("Ich spreche einen Tarnzauber und schleiche mich in die Praxis.", "event1_3_2"), new Choice("Ich spreche einen Schlafzauber auf den Beamten.", "event1_3_3"), new Choice("Ich wirke vorher einen Schockzauber, der ihm das Bewusstsein raubt.", "event1_3_4")]);
};

var event1_3_1_1 = function event1_3_1_1() {
    state.delay += 10;
    e.show("Der Polizist summt ein Lied. Es kommt dir bekannt vor. Lief das nicht neulich im Radio? Egal, du hast genug Zeit verschwendet.", [new Choice("Ich spreche einen Tarnzauber und schleiche mich in die Praxis.", "event1_3_2"), new Choice("Ich spreche einen Schlafzauber auf den Beamten.", "event1_3_3"), new Choice("Ich wirke vorher einen Schockzauber, der ihm das Bewusstsein raubt.", "event1_3_4")]);
};

var event1_3_2 = function event1_3_2() {
    e.show("Leise murmelst du den Zauberspruch, der deinen Körper lichtdurchlässig werden lässt. Dann schleichst du dich leise – man kann dich schließlich immer noch hören – an dem Beamten vorbei in die Praxis.", [new Choice("Weiter", "event1_4")]);
};

var event1_3_3 = function event1_3_3() {
    state.delay += 5;
    if (state.lore.value >= 20) {
        state.takedown += 1;
        e.show("Mit einem leisen Flüstern benebelst du den Geist des Polizisten, der sein Gähnen nicht länger unterdrücken kann, anfängt zu blinzeln, und dann in sich zusammen sackt. Anschließend wirkst du den Tarnzauber und schleichst in die Praxis.", [new Choice("Weiter", "event1_4")]);
    } else {
        e.show("Du zerbrichst dir den Kopf, aber dir fällt die richtige Formel nicht ein. Es muss wohl eine andere Möglichkeit her.", [new Choice("Ich lausche. Vielleicht spricht er gleich noch mit einigen Kollegen.", "event1_3_1"), new Choice("Ich spreche einen Tarnzauber und schleiche mich in die Praxis.", "event1_3_2"), new Choice("Ich wirke vorher einen Schockzauber, der ihm das Bewusstsein raubt.", "event1_3_4")]);
    }
};

var event1_3_4 = function event1_3_4() {
    state.profile += 5;
    state.takedown += 1;
    e.show("Da der Polizist eh schon müde und aufmerksam ist, fällt es dir leicht, seinen Kreislauf direkt anzugreifen. Als du die magischen Worte aussprichst, stockt sein Atem kurz, und er kippt bewusstlos zur Seite. Anschließend sprichst du einen Tarnzauber und trittst ein.", [new Choice("Weiter", "event1_4")]);
};

var event1_4 = function event1_4() {
    e.show("Der Empfangsraum der Praxis ist hell erleuchtet. Vor den steril wirkenden weißen Wänden sind die beiden Polizisten in ihren blauen Uniformen kaum zu übersehen. Nicht dass der Empfangsraum besonders groß wäre. Glücklicherweise sitzt einer von ihnen gelangweilt auf einem Stuhl und ließt eine Zeitschrift, während der andere mürrisch an dem Empfangstresen lehnt. Hinter den beiden erstreckt sich ein Flur, der zu den Untersuchungszimmern und Büros führt. Mit deiner Tarnung gelingt es dir problemlos, an den beiden vorbeizuschleichen. Als du im Dunkel des Flur stehst, zögerst du einen Augenblick. Da die Türen nur angelehnt sind, sollte es kein Problem sein, die Büros unbemerkt zu durchstöbern. Andererseits könntest du die Dunkelheit auch dazu nutzen, einen Zauber vorzubereiten, der die Beamten außer Gefecht setzt.", [new Choice("Ich kümmere mich um die beiden.", "event1_4_1"), new Choice("Ich warte einen Moment. Vielleicht klärt sich die Situation ja von ganz allein.", "event1_4_2"), new Choice("Die Dunkelheit sollte ausreichen.", "event1_5")]);
};

var event1_4_1 = function event1_4_1() {
    ...
    if (state.lore.value <= 10) {
        ...
        e.show(text, [new Choice("Dann doch lieber gleich in das Büro.", "event1_5"), new Choice("Mir ist wohler, wenn mich niemand überraschen kann.", "event1_4_1_2")]);
    } else {
...
var event1_4_1_2 = function event1_4_1_2() {
    state.delay += 5;
    state.takedown += 2;
    state.profile += 5;
    e.show("Leise flüsternd bündelst du deine Kräfte, und als du sie freigibst, kippen die Polizisten wie vom Schlag getroffen zur Seite.", [new Choice("Weiter", "event1_5")]);
};

var event1_4_2 = function event1_4_2() {
    state.delay += 5;
    e.show("Konzentriert lauschst du eine Weile. Der stehende Polizist fängt an, eine Melodie zu summen, und sein Partner ignoriert ihn.", [new Choice("Genug davon. Ich schleiche mich in das Büro.", "event1_5"), new Choice("Erst setzte ich die beiden außer Gefecht.", "event1_4_1_2")]);
};

var event1_5 = function event1_5() {
...
var event1_5_3 = function event1_5_3() {
    ...
    e.show(text, [new Choice("Es wird Zeit zu gehen.", "event1_6")]);
};

var event1_5_4 = function event1_5_4() {
    state.delay += 5;
    e.show("Es handelt sich um kleine, nussbraune Nachbildungen von Tieren, insbesondere Waldtieren. Hasen sind überraschend häufig vertreten, aber auch Wildschweine erfreuen sich gewisser Beliebtheit. Du untersuchst sie von allen Seiten, aber falls sie einen Hinweis verbergen, entgeht er dir.", [new Choice("Ich werfe einen ausführlichen Blick in das magische Spektrum, auch wenn das Zeit kostet.", "event1_5_1"), new Choice("Kein Tresor diese Welt kann sich meinen Kräften wiedersetzen. Mit etwas kinetischer Energie sollte ich die Tür aushebeln können.", "event1_5_2"), new Choice("Vielleicht findet sich im Schreibtisch oder Computer ein Hinweis, wie der Tresor zu öffnen ist.", "event1_5_3"), new Choice("Ich untersuche das Bücherregal.", "event1_5_5")]);
};

var event1_5_5 = function event1_5_5() {
    state.delay += 5;
    e.show("Medizinische Skizzen, Tabellen und Nachschlagewerke. Du schlägst einige auf Geratewohl auf. Anscheinend steht die Bezeichnung A00.0 für Cholera. Nach einigen ähnlichen Entdeckungen gibst du auf.", [new Choice("Ich werfe einen ausführlichen Blick in das magische Spektrum, auch wenn das Zeit kostet.", "event1_5_1"), new Choice("Kein Tresor diese Welt kann sich meinen Kräften wiedersetzen. Mit etwas kinetischer Energie sollte ich die Tür aushebeln können.", "event1_5_2"), new Choice("Vielleicht findet sich im Schreibtisch oder Computer ein Hinweis, wie der Tresor zu öffnen ist.", "event1_5_3"), new Choice("Diese Holzfigürchen wirken irgendwie verdächtig. Möglicherweise bergen sie einen Hinweis?", "event1_5_4")]);
};

var event1_6 = function event1_6() {
    var text = "Ein Kribbeln in deiner Hand ist die einzige Warnung, die du kriegst. Plötzlich löst der Kristall einen magischen Impuls aus, der sich wie ein Donnerschlag durch das magische Spektrum zieht. Du fluchst, denn obwohl kein gewöhnlicher Mensch dies bemerken kann, hast du ein für jeden Magieanwender leicht erkennbares Signalfeuer gezündet. Falls der magische Spezialist der Polizei noch nicht eingetroffen sein sollte, wird er nun mit höchster Geschwindigkeit herbei eilen.<br/><br/>";
    var tackeled = false;
    if (state.takedown >= 3) {
    ...
    if (tackeled) {
        var value = e.getRnd(0, 5) + state.takedown + (state.mundane.value >= 30 ? 1 : 0);
        if (value >= 3) {
...
var event1_7 = function event1_7() {
    ...
    e.show(text, [new Choice("Ich versuche den Taxifahrer zu überreden", "event1_7_1"), new Choice("Ich haste über die Straße", "event1_7_2"), new Choice("Ich sprinte den Bürgersteig entlang", "event1_7_3")]);
};

var event1_7_1 = function event1_7_1() {
    e.show("Du eilst auf den Taxifahrer zu, welcher sich nur widerwillig vom Spektakel löst. Offensichtlich war es nicht beruflicher Eifer, der ihn dazu bewogen hat, gerade hier zu halten. Du wirst dir etwas Gutes einfallen lassen müssen, damit er sich schneller bewegt.", [new Choice("„Ich muss unbedingt zum Flughafen, mein Flug geht in Kürze!”", "event1_7_1_1"), new Choice("„Ich muss unbedingt zum Flughafen, mein Flug geht in Kürze! Bitte schnell, ich lege auch einen Hunderter drauf!”", "event1_7_1_2"), new Choice("„Entschuldigung, sind sie noch frei? Ich habe es eilig.”", "event1_7_1_3")]);
};

var event1_7_1_1 = function event1_7_1_1() {
    if (state.delay >= 80) {
...
var event1_7_1_1a = function event1_7_1_1a(successValue) {
    var text = '';
...
var event1_7_2 = function event1_7_2() {
    var text = '';
    var difficulty = 30;
    if (state.delay >= 80) {
        difficulty = 55;
    ...
    if (e.getRnd(0, 59) + state.mundane.value >= difficulty) {
        // (random 0-59, each mundane +1 value, success if result >=55)
...
var event1_7_3 = function event1_7_3() {
    var text = "Du verfällst in einen schnellen Dauerlauf und zwingst dich zu einer gleichmäßigen Atmung, doch schon nach kurzer Zeit wird dein Atem schneller. Getrieben von der Angst vor einer möglichen Entdeckung, versuchst du, eine Balance zwischen dem Brennen in deiner Lunge und in deinen Beinen zu finden.";
    var difficulty = 30;
    if (state.delay >= 80) {
        difficulty = 55;
    }
    if (e.getRnd(0, 59) + state.mundane.value >= difficulty) {
        // (random 0-59, each mundane +1 value, success if result >=55 [if delay>=80] /30 [if else] )
...
var event1_8 = function event1_8() {
    var text = '';
    if (state.damage >= 1) {
...
var event1_8_3 = function event1_8_3() {
    ...
    e.show(text, [new Choice("Weiter", "event1_8_4")]);
};

var event1_8_4 = function event1_8_4() {
    e.show("Was wird die Zukunft bringen? Wird die Polizei dir auf die Schliche kommen? Wirst du ein Heilmittel gegen Krebs finden? Oder wirst du unter ungeklärten Umständen ein tragisches Ende finden?<br/><br/>Was auch immer die Zukunft bringt, du kannst sie mitgestalten. Nimm dir drei Minuten und gib uns ein kurzes Feedback. <br/>Gab es Problem oder Unklarheiten?<br/>Was hat dir besonders gefallen?<br/>Und bitte sei ehrlich, denn nur so können wir die Spielerfahrung verbessern.", [new Choice("Weiter", "event2_0")]);
};

var event2_0 = function event2_0() {
